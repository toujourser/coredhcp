...
LABEL BUILD="docker build -t toujourser/coredhcp -f Dockerfile ."
LABEL RUN="docker run --rm -it toujourser/coredhcp"
...
ENV PROJDIR=/build/src/github.com/toujourser/coredhcp
RUN mkdir -p $PROJDIR
COPY . $PROJDIR
